...
public class WeatherAverageBean implements Serializable {
	...
	public WeatherAverageBean(LocalDate date, BigDecimal daily, BigDecimal nightly, BigDecimal pressure,
	...
	public void plusMap(WeatherMapTimeBean map) {
		if (map.isDaily()) {
